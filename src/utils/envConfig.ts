export const envConfig = {
  ...
  TOKEN:
    typeof window === "undefined" ? "" : localStorage.getItem("access_token"), // This is just a placeholder. In a real application, you would retrieve the token from a secure storage or context.
